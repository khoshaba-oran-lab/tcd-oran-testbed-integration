...
CANON_SCRIPT="scripts/experiment-harness/canonicalize-iperf-receiver-t2.py"
SCHEMA="datasets/schemas/sci-oran-prompt12-t2-26to39-v1.0.0.schema.json"
...
validate_experiment_id()
{
    ...
    [[ "$value" =~ ^EXP-[0-9]{8}-T2-26TO39-DL-18000K-R0[1-4]$ ]] || \
